    ...
    let steps = [
        {
            ...
            description:
                "Just want to Introduce Shopping",
        },
        {
            name: "Utlimate Todos",
...
<main class="flex flex-col flex-1 p-4">
    ...
    >
        ...
        >
            <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
                Hi! This is <span class="poppins text-violet-400"></span> Aswathy Panakkaparambil
                <br />developers
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-10">
            ...
            <Step step={steps[1]}>
                <p>
                    ...
                    >
                    & <strong class="text-violet-400">DATABASE</strong> ALLOWING TO CONNECT WITH BOTH
                </p>
            </Step>
            <Step step={steps[2]}>
                <p>
                    SVELTE<strong class="text-violet-400"
    ...
    >
        ...
        >
            ...
            <h3 class="font-semibold text-3xl sm:text-4xl md:text-5xl">
                TRY<span class="poppins text-violet-400">about</span> IT
            </h3>
        </div>
